...
from enzymeexplorer import explore_sites, plot_volcano, plot_bar, plot_log2fold_change
...
if st.button('Run'):
    ...
    df = explore_sites(peptides, n=single_site, c_term=residue_term, aa_categories=use_categories)
